					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
								...
								<img src="<?= $image?>" class="avatar img-fluid rounded mr-1" alt="<?php echo $user['firstname'].' '.$user['lastname']; ?>" /> <span class="text-dark">
									<?php echo $user['firstname'].' '.$user['lastname']; ?>
								</span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="pages-settings.php"><i class="align-middle mr-1" data-feather="user"></i> Profile</a>
